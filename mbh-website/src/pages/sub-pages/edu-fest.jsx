...
const achievements = [
  { img: EducationFestival2024, year: "2024", place: "1st Place" },
  { img: EducationFestival2023, year: "2023", place: "1st Place" },
];
      ...
      <div className="w-full flex flex-col pt-20">
        ...
        <div className="w-full h-[auto] bg-[#f5f5f5] flex flex-col text-center px-10 py-15 gap-6">
          <div className="relative w-full flex items-center py-4 px-6">
            ...
            <div className="mx-auto text-2xl font-bold text-center">Education Festival</div>
          </div>
          <div className="text-lg px-6">
            Running annually since 2021, UNSW's Education Festival is a celebration of education and educators both
            within UNSW and the broader education community.
            <br />
            The festival features projects built through cross-faculty collaboration, featuring presentations from
          ...
          <div className="px-6">
            <button
              onClick={() =>
                window.open(
                  "https://www.education.unsw.edu.au/news-events/unsw-education-festival",
                  "_blank",
                  "noopener,noreferrer"
                )
              }
